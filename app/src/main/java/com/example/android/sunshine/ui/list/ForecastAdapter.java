...
/**
 * Exposes a list of weather forecasts from a list of {@link ListViewWeatherEntry} to a {@link RecyclerView}.
 */
        ...
        if(mForecast == null){
            ...
            DiffUtil.DiffResult result = DiffUtil.calculateDiff(new DiffUtil.Callback() {
                ...
                public boolean areItemsTheSame(int oldItemPosition, int newItemPosition) {
                    ...
                    return oldWeather.getId() == newWeather.getId();
                }
                ...
                public boolean areContentsTheSame(int oldItemPosition, int newItemPosition) {
                    ...
                    ListViewWeatherEntry newWeather = newForecast.get(newItemPosition);
                    return oldWeather.getId() == newWeather.getId() &&
                            oldWeather.getDate().equals(newWeather.getDate());
                }
            });
